...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> SMART MEDICAL SYSTEM</h2></br>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select doctor,docFees,ID,appdate,apptime,disease,allergy,prescription from prestb where pid='$pid';";
                      ...
                      <tr>
                        ...
                        <form method="post" action="pay.php?checkout=automatic">
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <?php $dFees=$row['docFees'];?>

                              <a href="">
                              <input type ="hidden" name="ID" value="<?php echo $row['ID']?>"/>
                              <input type ="hidden" name="DF" value="<?php echo $dFees?>"/>

                              <input type = "submit"  name ="bill" class = "btn btn-success" value="Pay Bill"/>
                              </a>
                              </td>
                              </form>
