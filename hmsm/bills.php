...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   </h3><a href="#list-pres" onclick="clickDiv('#list-pres-list')">
    <div class="row">
    <center><div >
            ...
            ?>
                       ...
                       <form method="get" >
                        ...
                        <input style="margin-left:40em;"type = "submit" onclick="alert('Bill Paid Successfully');" name ="generate_bill" class = "btn btn-success" value="Download Receipt"/>
                        </a>
